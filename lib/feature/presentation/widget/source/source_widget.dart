...
class SourceWidget extends StatelessWidget {
  const SourceWidget({super.key, required this.model});
    ...
    return DefaultTabController(
     // initialIndex: index??0,
      ...
      child: TabBar(
        ...
        padding: EdgeInsets.zero,unselectedLabelColor: Colors.black,
        dividerColor: Colors.transparent,indicatorColor: Colors.black,
