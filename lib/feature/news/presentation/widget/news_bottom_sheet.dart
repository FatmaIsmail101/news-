...
Article articleModel;
  ...
  Widget build(BuildContext context) {
    ...
    String preview = fullText.length > maxLength
        ? fullText.substring(0, maxLength) + "... [+" + (fullText.length - maxLength).toString() + " chars]"
        : fullText;
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(preview,style: GoogleFonts.inter(
                fontWeight: FontWeight.w500,fontSize: 14,color: AppColor.mainColorDark
            )
              ,),
            ...
            ElevatedButton(onPressed: (){
              ...
              (context.findAncestorStateOfType<HomeScreenState>())
                  ?.showFullArticle(articleModel);
            },
            style:ElevatedButton.styleFrom(backgroundColor: AppColor.mainColorDark,
           shape: RoundedRectangleBorder(
             borderRadius: BorderRadius.circular(8)
                ) ,padding: EdgeInsets.symmetric(vertical: 16)) , child: Text("View Full Article",
              style: GoogleFonts.inter(color: AppColor.mainColorLight,
